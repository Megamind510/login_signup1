...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
      ...
      body: Stack(
        children: [
                  ...
                  children: [
                    RichText(
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: isSignupScreen ? " LINCOLN," : " Back,",
                              style: TextStyle(
                                fontSize: 30,
          ...
          Positioned(
            ...
            child: Column(
              children: [
                Text(isSignupScreen ? " Signup with" : "Signin with"),
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      buildTextButton(MaterialCommunityIcons.gmail, "gmail",
                          Palette.googleColor),
                    ],
                  ),
                )
  ...
  Container buildSigninSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(Icons.mail_outline, "info@jubilee.com", false, true),
          buildTextField(
